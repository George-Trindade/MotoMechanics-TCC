...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Atualizar Veículo</div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('veiculos.update', $veiculo->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="modelo" name="Modelo" value="{{ old('Modelo', $veiculo->Modelo) }}" required>
                            </div>

                            <div class="form-group">
                                <label for="marca">Marca:</label>
                                <input type="text" class="form-control" id="marca" name="Marca" value="{{ old('Marca', $veiculo->Marca) }}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cor" name="Cor" value="{{ old('Cor', $veiculo->Cor) }}" required>
                            </div>
